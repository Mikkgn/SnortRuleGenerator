...
class AMQPConsumer(object):
    ...
    def on_queue_declareok(self, _unused_frame: pika.frame.Method, userdata: str):
        ...
        """
        queue_name = userdata
        self._logger.info('Binding %s to %s with %s', self._exchange, queue_name,
                          self._routing_key)
    ...
    def on_basic_qos_ok(self, _unused_frame: pika.frame.Method):
