...
from analyzer.analyze_utils import AttackDefinition
...
class Listener(AMQPClient):
    ...
    def _process_start_or_stop_event(self, reader: READERS, action: ACTIONS, *args: Any, **kwargs: Any):
    ...
    def _start_reader(self, reader: READERS, definitions: List[Dict], *args: Any, **kwargs: Any):
        ...
        definitions_ = [AttackDefinition(attack_definition) for attack_definition in definitions]
        self._analyzer = PacketAnalyzer(queue_=self._queue, definitions=definitions_, *args, **kwargs)
